-- Post revisions
	...
	BEGIN
		...
		SELECT post_content_revision.post_id, post_content_revision.language_id, post_content_revision.created_at, post_content_revision.admin_id, admin.display_name, admin.username
			...
			LEFT JOIN admin ON (admin.admin_id = post_content_revision.admin_id)
		WHERE 1 = 1
		...
		ORDER BY post_content_revision.created_at DESC
