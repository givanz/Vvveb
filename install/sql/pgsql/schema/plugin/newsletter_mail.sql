...
CREATE TABLE IF NOT EXISTS "newsletter_mail" (
  ...
  "data" text NOT NULL,
  "status" smallint(6) NOT NULL DEFAULT '0', -- inactive = 0, active = 1, unsubsubscribed = 2 
  "created_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
);

CREATE INDEX "newsletter_mail_email_newsletter_list_id" ON post ("email","newsletter_list_id");
